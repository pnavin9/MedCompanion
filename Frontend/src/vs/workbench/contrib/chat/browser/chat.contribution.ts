...
import { DicomImplicitContextContribution } from './contrib/chatDicomImplicitContext.js';
...
registerWorkbenchContribution2(DicomImplicitContextContribution.ID, DicomImplicitContextContribution, WorkbenchPhase.Eventually);
