...
import { ChatAgentLocation, ChatConfiguration, ChatDomain, ChatMode } from './constants.js';
...
export namespace ChatContextKeys {
	...
	export const chatMode = new RawContextKey<ChatMode>('chatMode', ChatMode.Consult, { type: 'string', description: localize('chatMode', "The current chat mode.") });
	export const chatDomain = new RawContextKey<ChatDomain>('chatDomain', ChatDomain.General, { type: 'string', description: localize('chatDomain', "The current chat domain.") });
...
export namespace ChatContextKeyExprs {
	...
	export const inEditingMode = ContextKeyExpr.or(
		ChatContextKeys.chatMode.isEqualTo(ChatMode.Plan),
		ChatContextKeys.chatMode.isEqualTo(ChatMode.Agent),
		ChatContextKeys.chatMode.isEqualTo(ChatMode.Diagnose),
	);
}
